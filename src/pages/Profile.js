      ...
      >
        <Form form={form} layout="vertical" name="edit_form">
          ...
          <Form.Item name="telegram" label="Telegram">
            <Input addonBefore="@" placeholder="your telegram username" />
          </Form.Item>
          ...
          <Form.Item name="instagram" label="Instagram">
            <Input addonBefore="@" placeholder="your instagram profile" />
          </Form.Item>
        </Form>
      </Modal>
    );
          ...
          >
            ...
            <Row align="middle">
              <Col span={8}>
                ...
                >
                  {userProfile.photo ? (
                    <Avatar style={{height: "5rem", width: "5rem"}} src={userProfile.photo} />
                  ) : (
                    <Avatar
                ...
                >
                  ...
                  <Col>
                    <Space direction="vertical">
                      ...
                      {userProfile && userProfile.telegram && (
                        <Row align="middle" gutter={[16, 16]}>
                          <Col>
                            <WhatsAppOutlined />
                          </Col>
              ...
              <Col span={15}>
                {userStats && (
                  <Row justify="space-around" style={{ marginBottom: "36px" }}>
                    <Col>
                ...
                >
                  ...
                  >
                    ...
                    {owner && (
                      <Col>
                        <AddTag onClick={() => setTagVisible(true)}>
                          + Add
                        </AddTag>
                        {<TagModal />}
                      </Col>
